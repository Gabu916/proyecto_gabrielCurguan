...
import com.portafolio.csg.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        if(sExperiencia.existsByNombreE(dtoexp.getNombreE()) && sExperiencia.getByNombreE(dtoexp.getNombreE()).get().getId() !=id)
            return new ResponseEntity(new Mensaje("Esa Experienccia ya existe"),HttpStatus.BAD_REQUEST);
        ...
        sExperiencia.save(experiencia);
        return new ResponseEntity(new Mensaje("Experienccia actualizada"),HttpStatus.OK);
    }
